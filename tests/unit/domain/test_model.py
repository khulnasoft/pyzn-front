...
from pyzn.domain.model import ProjectName, Project, Downloads, ProjectVersionDownloads, DayDownloads
...
def test_normalize_project_name():
    project = ProjectName("pyzn-test.project")
    assert "pyzn-test-project" == project.name
